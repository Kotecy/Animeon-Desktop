...
contextBridge.exposeInMainWorld('api', {
  ...
  utilitiesToggle: (id: string) => ipcRenderer.invoke('utilities:toggle', id),
  utilitiesImport: (slot: number, name: string, source: string) => ipcRenderer.invoke('utilities:import', slot, name, source),
  utilitiesMove: (id: string, slot: number) => ipcRenderer.invoke('utilities:move', id, slot),
  utilitiesRemove: (id: string) => ipcRenderer.invoke('utilities:remove', id),
  ...
  detectorOpenModal: () => ipcRenderer.invoke('detector:openModal'),
  onCommandsToggle: (cb: () => void) => subscribe('commands:toggle', () => cb()),
  addressContextMenu: (url: string) => ipcRenderer.invoke('address:contextMenu', url),
  onAddressPasted: (cb: (text: string) => void) => subscribe('address:pasted', (_e, text) => cb(text)),
  onAddressPasteAndGo: (cb: (text: string) => void) => subscribe('address:pasteAndGo', (_e, text) => cb(text)),
