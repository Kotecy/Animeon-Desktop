...
async function fixture(options = {}) {
  ...
  ctx = vm.createContext({ Map, Set, Date, URL, utilityEpoch: 0, collectionEpoch: 0, AUTO_COLLECT_AVAILABLE: options.publicBuild !== true, waitForCollection: async () => options.cancelWait !== true, profileSwitchBusy: false,
...
async function run() {
  ...
  for (const options of [{ watching: false }, { autoCollect: false }, { publicBuild: true }, { cancelWait: true }]) {
